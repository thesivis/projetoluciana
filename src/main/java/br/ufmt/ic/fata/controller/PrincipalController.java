...
import br.ufmt.ic.fata.dao.SujeitoDaoImp;
import br.ufmt.ic.fata.dao.VerboDaoImp;
    ...
    static {
        ...
        if (FATA_DIR == null) {
            if (System.getProperty("os.name").toLowerCase().contains("windows")) {
                ...
                FATA_DIR = "/home/cleyton/FATA_DIR/";
            }
            File dir = new File(FATA_DIR);
            if (!dir.exists()) {
                boolean dirCreated = dir.mkdirs();
                if (!dirCreated) { throw new IllegalStateException("Criação do diretório FATA_DIR falhou."); }
            }
        }
    }
